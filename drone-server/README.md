...
เซิร์ฟเวอร์นี้เปิดให้บริการ API สำหรับ Frontend ใช้งาน โดยมี Endpoint หลักดังนี้
...
* ใช้ Express + Node.js รันแบบ Lightweight เหมาะกับ Vercel
* ตัวแปรทั้งหมดต้องตั้งค่าใน .env และใน Vercel Environment
* รองรับการเรียกใช้งานจาก Frontend ทั้งใน Local และ Production
